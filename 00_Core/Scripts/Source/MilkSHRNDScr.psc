Scriptname MilkSHRNDScr extends activemagiceffect  
...
Event OnEffectStart( Actor akTarget, Actor akCaster )
	...
	if PlayerREF == akTarget
		if MilkQ.isSuccubus(akTarget) && MilkQ.Plugin_PSQ == true
			MilkQ.PSQ.AddEnergy()
		endif
		...
		int RND_SuccubusSatitation = 0
			...
			if RND_State.GetValue() == 1
					...
					RND_HungerPoints.SetValue(RND_HungerPoints.GetValue() - RND_FoodPoints.GetValue() - RND_SuccubusSatitation - AdjPoints)
					...
					elseif RND_HungerPoints.GetValue() >= RND_HungerLevel01.GetValue() && RND_FoodPoints.GetValue() + RND_SuccubusSatitation < RND_HungerLevel02.GetValue()
					...
					elseif RND_HungerPoints.GetValue() >= RND_HungerLevel02.GetValue() && RND_FoodPoints.GetValue() + RND_SuccubusSatitation < RND_HungerLevel03.GetValue()
					...
					elseif RND_HungerPoints.GetValue() >= RND_HungerLevel03.GetValue() && RND_FoodPoints.GetValue() + RND_SuccubusSatitation < RND_HungerLevel04.GetValue()
