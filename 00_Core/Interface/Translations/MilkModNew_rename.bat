copy /y MilkModNew_ENGLISH.txt MilkModNew_CHINESE.txt
copy /y MilkModNew_ENGLISH.txt MilkModNew_CZECH.txt
copy /y MilkModNew_ENGLISH.txt MilkModNew_FRENCH.txt
copy /y MilkModNew_ENGLISH.txt MilkModNew_GERMAN.txt
